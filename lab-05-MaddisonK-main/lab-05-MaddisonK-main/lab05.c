/*******************************************************************************
  ...
  Lab 05: COMP 211 Systems Fundamentals - Spring 2021
  ...
  3) For the CMF selected in (1) determine if it's a cache-hit or -miss (and 
     display to the user)
  4) if a cache-miss, determine the cache line to be replaced for the choosen 
     CMF. 
